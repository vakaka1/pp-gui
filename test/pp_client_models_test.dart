...
''';
    ...
    expect(PpClientService.parseLabeledValue(output, 'Build Date'), '2026-04-29T07:54:34Z');
  });
  ...
  test('создаёт клиентскую конфигурацию из ppf uri', () {
    final draft = ClientConfigDraft.fromPpfUri('ppf://office@example.com:443?pub=PUB&psk=PSK&path=/grpc&fp=chrome');
