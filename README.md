...
Скачайте `pp-gui-vX.X.X-windows-portable.zip`. Распакуйте архив в любую папку и запустите `pp_gui.exe`.  
Этот способ не требует прав администратора и удобен, если установщик не срабатывает.
